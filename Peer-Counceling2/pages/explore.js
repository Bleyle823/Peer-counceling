...
<>
    <br />
    <Head>
      <title>Watch -Peer-Counceling</title>
      <meta name="viewport" content="initial-scale=1.0, width=device-width" />
    </Head> 
<> 
        <center>
          <br />
          <h2 className="text-6xl font-bold leading-1 text-black-900 sm:text-5xl "> Welcome to our decentralized online counseling system! We provide secure, private, and convenient access to a variety of mental health services. </h2>
          <br />
        </center>
</>
